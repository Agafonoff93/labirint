...
let pageSlider = new Swiper('.block-info__item_radio-card', {

	wrapperClass:"block-info__list_big",
	slideClass: "item-list-checkout",
   ...
   observer: true,
	...
	navigation: {
		nextEl: '.block-info__arrow-next',
		prevEl: '.block-info__arrow-prev',
	},
	// pagination: {
	// 	el: '.block-info__arrow',
		// type:'bullets',
	// 	clickable:true,
